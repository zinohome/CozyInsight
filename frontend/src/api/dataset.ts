...
export const datasetAPI = {
  list: () => request.get<Dataset[]>('/api/v1/dataset'),
  create: (data: CreateDatasetRequest) => request.post<Dataset>('/api/v1/dataset', data),
  get: (id: number) => request.get<Dataset>(`/api/v1/dataset/${id}`),
  ...
  preview: (id: number, limit?: number) => request.get<PreviewDataResponse>(`/api/v1/dataset/${id}/preview`, { params: { limit } }),
}
